...
ind1= 45.d0*const1    !factor for 6 point first derivative finite diference in 1D along q1                                   |    !
ind2=  9.d0*const1    !factor for 6 point first derivative finite diference in 1D along q1                                   |    !
ind3=  1.d0*const1    !factor for 6 point first derivative finite diference in 1D along q1                                   |    !
!----------------------------------------------------------------------------------------------------------------------------|    !
...
ind1= 45.d0*const2    !factor for 6 point first derivative finite diference in 1D along q1                                |       !
ind2=  9.d0*const2    !factor for 6 point first derivative finite diference in 1D along q1                                |       !
ind3=  1.d0*const2    !factor for 6 point first derivative finite diference in 1D along q1                                |       !
!-------------------------------------------------------------------------------------------------------------------------|       !
...
q2(12)/mass(12)+nac21h4x(i+1,j+1)*q2(13)/mass(13)+nac21h4y(i+1,j+1)*q2(14)/mass(14)+nac21h4z(i+1,j+1)*q2(15)/mass(15)
    ...
    if ( nac10c0x(i+1,j+1) /= nac10c0x(i+1,j+1) ) then
      write(*,*)'nac10c0x = ',i+1,j+1,nac10c0x(i+1,j+1)
      read(*,*)
    end if
    if ( nac10c0y(i+1,j+1) /= nac10c0y(i+1,j+1) ) then
      write(*,*)'nac10c0y = ',i+1,j+1,nac10c0y(i+1,j+1)
      read(*,*)
    end if
    if ( nac10c0z(i+1,j+1) /= nac10c0z(i+1,j+1) ) then
      write(*,*)'nac10c0z = ',i+1,j+1,nac10c0z(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h1x(i+1,j+1) /= nac10h1x(i+1,j+1) ) then
      write(*,*)'nac10h1x = ',i+1,j+1,nac10h1x(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h1y(i+1,j+1) /= nac10h1y(i+1,j+1) ) then
      write(*,*)'nac10h1y = ',i+1,j+1,nac10h1y(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h1z(i+1,j+1) /= nac10h1z(i+1,j+1) ) then
      write(*,*)'nac10h1z = ',i+1,j+1,nac10h1z(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h2x(i+1,j+1) /= nac10h2x(i+1,j+1) ) then
      write(*,*)'nac10h2x = ',i+1,j+1,nac10h2x(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h2y(i+1,j+1) /= nac10h2y(i+1,j+1) ) then
      write(*,*)'nac10h2y = ',i+1,j+1,nac10h2y(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h2z(i+1,j+1) /= nac10h2z(i+1,j+1) ) then
      write(*,*)'nac10h2z = ',i+1,j+1,nac10h2z(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h3x(i+1,j+1) /= nac10h3x(i+1,j+1) ) then
      write(*,*)'nac10h3x = ',i+1,j+1,nac10h3x(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h3y(i+1,j+1) /= nac10h3y(i+1,j+1) ) then
      write(*,*)'nac10h3y = ',i+1,j+1,nac10h3y(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h3z(i+1,j+1) /= nac10h3z(i+1,j+1) ) then
      write(*,*)'nac10h3z = ',i+1,j+1,nac10h3z(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h4x(i+1,j+1) /= nac10h4x(i+1,j+1) ) then
      write(*,*)'nac10h4x = ',i+1,j+1,nac10h4x(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h4y(i+1,j+1) /= nac10h4y(i+1,j+1) ) then
      write(*,*)'nac10h4y = ',i+1,j+1,nac10h4y(i+1,j+1)
      read(*,*)
    end if
    if ( nac10h4z(i+1,j+1) /= nac10h4z(i+1,j+1) ) then
      write(*,*)'nac10h4z = ',i+1,j+1,nac10h4z(i+1,j+1)
      read(*,*)
    end if
...
write(*,*)'Sum q2 = ',sum(q1**2.d0)
write(*,*)'Sum ham = ',sum(ham)

do i=0,n-1
  do j=0,n-1
    if ( ham(i,j) /= ham(i,j) ) then 
      write(*,*)i,j,ham(i,j)
      read(*,*)
    end if
  end do
