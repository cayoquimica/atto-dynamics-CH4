...
integer,parameter                          :: npoints = 20000 !Number of time steps to take in the simulation
...
real(kind=dp),parameter                    :: hi=2.01410177811_dp*saw2au   !1.00794_dp*saw2au !Hidrogen mass in atomic units
...
complex(kind=dp),allocatable    :: y_h(:,:),y_d(:,:)
...
do k=1,Nst
  do j=1,Nq2
    do i=1,Nq1
      co1(ll)=(i-Nq1/2.0_dp-1.0_dp)*sq1+sq1/2.0_dp!(Nq1-Nq11/2.0_dp-i)*sq1+sq1/2.0_dp
