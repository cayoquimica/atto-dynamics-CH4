...
integer, parameter                         :: Nq1=126 !126 !number of points of the grid along q1
integer, parameter                         :: Nq2=179 !179 !number of points of the grid along q2
...
real(kind=dp), parameter                   :: sq2=0.0675d0 !step in q1 in atomic units
...
open(unit=1,file='v1.txt',status='old')                             !
open(unit=2,file='v2.txt',status='old')                             !
open(unit=3,file='v3.txt',status='old')                             !
do i=1,Nq1                                                          !
  read(1,*) pot1(i,:)                                               !
  read(2,*) pot2(i,:)                                               !
  read(3,*) pot3(i,:)                                               !
...
do j=0*Nq1,(Nq2-1)*Nq1,Nq1 ! Moving through the boxes, from the fisrt to the last one                                             !
  do i=1,Nq1 ! Moving inside the box                                                                                              !
    ...
    Ha( 1*s + j + i , 1*s + j + i ) = Ha( 1*s + j + i , 1*s + j + i ) + pot2 (i,(j+Nq1)/Nq1)                                      !
    Ha( 2*s + j + i , 2*s + j + i ) = Ha( 2*s + j + i , 2*s + j + i ) + pot3 (i,(j+Nq1)/Nq1)                                      !
  end do ! end of do through single box                                                                                           !
end do ! end of do through boxes                                                                                                  !
!=================================================================================================================================!                       
