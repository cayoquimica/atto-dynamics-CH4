...
write(20,'(i12)')k_moq1
do i=0,k_moq1-1
  write(20,'(e50.40e3,2i12)')moq1_val(i),moq1_row_col(i,0),moq1_row_col(i,1)
end do
do i=0,n
...
write(20,'(i12)')k_moq2
do i=0,k_moq2-1
  write(20,'(e50.40e3,2i12)')moq2_val(i),moq2_row_col(i,0),moq2_row_col(i,1)
end do
do i=0,n
...
write(20,'(i12)')k_Ha
do i=0,k_Ha-1
  write(20,'(e50.40e3,2i12)')Ha_val(i),Ha_row_col(i,0),Ha_row_col(i,1)
end do
do i=0,n
...
write(20,'(i12)')k_am
do i=0,k_am-1
  write(20,'(e50.40e3,2i12)')am_val(i),am_row_col(i,0),am_row_col(i,1)
end do
do i=0,n
