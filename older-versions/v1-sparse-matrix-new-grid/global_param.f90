...
real(kind=dp), parameter                   :: t00 = 30 !time where the pulse is centered
real(kind=dp), parameter                   :: phase = 0.d0 !phase factor for the pulse related to the gaussian envelope
real(kind=dp), parameter                   :: freq = 0.056937d0 !frequency of the pulse, in a.u. - 800 nm of wavelength
real(kind=dp), parameter                   :: sig = 30  ! 50 approx 1200 attoseconds - width of the gaussian envelop
