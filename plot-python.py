...
#np.savetxt('pop-csc-st0.txt',popcs0c)
#np.savetxt('pop-csc-st1.txt',popcs1c)
#np.savetxt('pop-csc-st2.txt',popcs2c)
#
...
#np.savetxt('pos-csc-st0.txt',poscs0c)
#np.savetxt('pos-csc-st1.txt',poscs1c)
#np.savetxt('pos-csc-st2.txt',poscs2c)
#
...
cs0c = np.loadtxt('csc-st0.txt')
cs1c = np.loadtxt('csc-st1.txt')
cs2c = np.loadtxt('csc-st2.txt')
...
popcs0c = np.loadtxt('pop-csc-st0.txt')
popcs1c = np.loadtxt('pop-csc-st1.txt')
popcs2c = np.loadtxt('pop-csc-st2.txt')
...
poscs0c = np.loadtxt('pos-csc-st0.txt')
poscs1c = np.loadtxt('pos-csc-st1.txt')
poscs2c = np.loadtxt('pos-csc-st2.txt')
