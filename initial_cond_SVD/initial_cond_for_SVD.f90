...
complex(kind=dp)             :: mom(0:Nst*Nq1*Nq2-1),am(0:Nst*Nq1*Nq2-1),soma !vectors to store operators acting on the wave function
...
open(newunit=init_wf,file='eigen-vec-neutral_deut',status='unknown')
k=0
do i=0,s-1
...
!  open(unit=67,file='initial-wf-real',status='unknown')
!  open(unit=68,file='initial-wf-imag',status='unknown')
!  do i =0,n-1
!    write(67,'(e20.10e3)')real(wf0(i))
!    write(68,'(e20.10e3)')aimag(wf0(i))
!  end do
